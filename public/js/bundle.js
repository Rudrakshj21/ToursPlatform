      ...
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            ...
            (0, _alerts.showAlert)('error', 'cannot logout.....');
          }
          _context2.next = 11;
          break;
        case 8:
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          url = "".concat(type == 'password' ? '/api/v1/users/updatePassword' : '/api/v1/users/updateMe');
          _context.next = 4;
          return (0, _axios.default)({
            url: url,
            data: data,
        ...
        case 4:
          ...
          if (res.data.status == 'success') {
            ...
            (0, _alerts.showAlert)('error', res.data);
          }
          _context.next = 12;
          break;
        case 9:
...
var bookTour = exports.bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourID) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          stripe = Stripe('pk_test_51P2ZKcSAoU62bNurJQk7YyZR7RPkVCHvKYhwqfPEL7htdyITRroLknrYIcNujqOc90yrqt371A115R7OYaICWbQG00vNHG5lMD');
...
if (formUserPassword) {
  formUserPassword.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var currentPassword, updatePassword, updatePasswordConfirm;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            ...
            updatePasswordConfirm = document.getElementById('password-confirm').value; // console.log(passwordConfirm, password, passwordConfirm);
            _context.next = 7;
